        ...
        <div className='home-container'>
            <div className="main ">
                <div className="data">
                    ...
                    <h1  style={{color:props.mode ? 'white':''}}>SAQIB TAHIR</h1>
                    <h3 style={{color:props.mode ? 'white':''}}>& I'am a Web Developer </h3>
                    <p style={{color:props.mode ? 'white':''}}>  Building Responsive and user-friendly interfaces that captivate and engage users</p>
                    <div className="btn">
